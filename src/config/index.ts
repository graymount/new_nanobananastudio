...
export const envConfigs: ConfigMap = {
  ...
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'TextRender Studio',
  ...
  auth_url: process.env.NEXT_PUBLIC_AUTH_URL || process.env.AUTH_URL || process.env.NEXT_PUBLIC_APP_URL || '',
